                ...
                execute: function () {
                        ...
                        _export('NegociacaoDAO', NegociacaoDAO = function () {
                                function NegociacaoDAO(connection) {
                                        ...
                                        this._store = 'negociacoes'; //esse DAO vai operar sobre a store(tabela do navegador) negociacoes
                                }
                                ...
                                _createClass(NegociacaoDAO, [{
                                        ...
                                        value: function apagaTodos() {
                                                ...
                                                return new Promise(function (resolve, reject) {
                                                        ...
                                                        var request = _this3._connection.transaction([_this3._store], 'readwrite').objectStore(_this3._store).clear(); //clear apaga a objectStore
